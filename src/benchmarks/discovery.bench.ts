...
describe('discovery benchmarks', () => {
  bench('createDiscoveryState cached repeat', () => {
    createDiscoveryState(baseFixture.appNodes, baseFixture.searchQuery, baseFixture.activeTag);
  });
  ...
  bench('createDiscoveryState cold canvas', () => {
    ...
    createDiscoveryState(fixture.appNodes, fixture.searchQuery, fixture.activeTag);
  });
});
