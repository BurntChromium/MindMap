...
function createEntityStore() {
  ...
  const cacheByCanvasId = new Map<string, { entities: Entity[]; mentions: EntityMention[] }>();
  let loadToken = 0;
  ...
  return {
    ...
    hydrate(entities: Entity[], mentions: EntityMention[], activeCanvasId: string | null = null) {
